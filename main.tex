...
%To measure this dispersion relation I have been adjusting the frequency generator connected to the actuator to a frequency and measured the wavelength of the wave (see section 4.1.3).
...
%\begin{figure}[hbt]
%  \includegraphics[width=.7\columnwidth]{condition2_results_amplitude_ratio}
 % \caption{Amplitude ratio $|X_N|/|X_0|$ between the first and last lever of the wave machine% under harmonic excitation}
%\end{figure}
...
\end{figure*}
\clearpage
\includepdf[pages=-]{python_code_c2.pdf}
\includepdf[pages=-]{python_code_c1.pdf}
\includepdf[pages=-]{python_code_c3.pdf}
